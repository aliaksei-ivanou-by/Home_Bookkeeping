...
Transaction::Transaction(
  ...
  amount_{ amount },
  amount_account_from_{ 0 },
  amount_account_to_{ 0 },
...
Transaction::Transaction(
  ...
  time_{},
  account_from_{ std::make_shared<Account>(transactionAccountFromForAdd) },
  account_to_{ std::make_shared<Account>(transactionAccountToForAdd) },
  category_{ std::make_shared<Category>(transactionCategoryForAdd) },
  amount_{ transactionAmountForAdd },
  amount_account_from_{ 0 },
  amount_account_to_{ 0 },
  comment_{ std::make_shared<Comment>(Comment()) },
  currency_{ std::make_shared<Currency>(Currency()) },
