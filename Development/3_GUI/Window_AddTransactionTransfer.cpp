#include "home_bookkeeping/3_GUI/Window_AddTransactionTransfer.h"

Window_AddTransactionTransfer::Window_AddTransactionTransfer(
...
{
  PLOG_ERROR << "Transation no added";
  button_pushed = true;
  hide();
}
