...
void FinanceRepository::SaveToDatabaseTransactions() const
{
  char* err = 0;
  int rc = 0;
  ...
  for (auto i = transaction_repository_.Begin(); i != transaction_repository_.End(); ++i)
  {
    ...
    if (rc != SQLITE_OK)
    {
      PLOG_ERROR << "SQL Insert Error: " << err;
    }
    ++j;
  }
}
...
void FinanceRepository::SaveToDatabaseCategories() const
{
  char* err = 0;
  int rc = 0;
...
void FinanceRepository::SaveToDatabaseCurrencies() const
{
  char* err = 0;
  int rc = 0;
...
void FinanceRepository::SaveToDatabaseDescriptions() const
{
  char* err = 0;
  int rc = 0;
...
void FinanceRepository::SaveToDatabasePayees() const
{
  char* err = 0;
  int rc = 0;
...
void FinanceRepository::SaveToDatabaseComments() const
{
  char* err = 0;
  int rc = 0;
...
void FinanceRepository::SaveToDatabaseTags() const
{
  char* err = 0;
  int rc = 0;
