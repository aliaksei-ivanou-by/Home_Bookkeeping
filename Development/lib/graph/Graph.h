#ifndef HOMEBOOKKEEPING_LIB_GRAPH_GRAPH_H_
#define HOMEBOOKKEEPING_LIB_GRAPH_GRAPH_H_
...
#undef minor
  ...
  struct Axis : Shape
  {
    ...
    Axis(Orientation d, Point xy, int length, int number_of_notches = 0, std::string label = "");
    void draw_lines() const;
...
#endif  //  HOMEBOOKKEEPING_LIB_GRAPH_GRAPH_H_
